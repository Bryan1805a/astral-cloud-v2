...
const NAV_ITEMS = [
  ...
  { href: "/dashboard/gdpr", label: "Data & Privacy", icon: PrivacyIcon },
];
...
const ADMIN_ITEMS = [
  ...
  { href: "/dashboard/admin/regions", label: "Regions", icon: RegionIcon },
  ...
  { href: "/dashboard/admin/feature-flags", label: "Feature Flags", icon: FlagIcon },
  { href: "/dashboard/admin/tax-rates", label: "Tax Rates", icon: TaxIcon },
  { href: "/dashboard/admin/email-templates", label: "Email Templates", icon: EmailTemplateIcon },
      ...
      <aside className="fixed inset-y-0 left-0 z-30 flex w-56 flex-col border-r border-gray-800 bg-gray-900">
        ...
        <nav className="flex-1 space-y-1 px-3 py-4">
          ...
          {user && (user.role === "ADMIN" || user.role === "STAFF") && (
            <>
              <div className="pt-4">
                <p className="px-3 text-[11px] font-semibold uppercase tracking-wider text-gray-500">Admin</p>
              </div>
...
function SshKeyIcon({ className }: { className?: string }) {
  return (
    <svg className={className} fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
...
function FloatingIpIcon({ className }: { className?: string }) {
  return (
    <svg className={className} fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
...
function ImageIcon({ className }: { className?: string }) {
  return (
    <svg className={className} fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
      ...
      <path strokeLinecap="round" strokeLinejoin="round" d="M16.5 12.75a4.5 4.5 0 11-9 0 4.5 4.5 0 019 0zm2.25-2.25h.008v.008h-.008V10.5z" />
    </svg>
  );
}
...
function EmailTemplateIcon({ className }: { className?: string }) {
  return (
    <svg className={className} fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
